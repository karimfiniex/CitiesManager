...
export class CitiesComponent {
  ...
  //Excutes when from clicks on 'Edit' button for the particular city
  editClicked(city: City): void {
    this.editCityID = city.cityID;
  }

  //Excutes when from clicks on 'Update' button after Editing
  ...
  //Excutes when the 'Refresh' method is clicked
  refreshClicked(): void {
